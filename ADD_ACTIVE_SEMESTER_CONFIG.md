# Add ActiveSemesterConfig Model Manually

## সমস্যা

Server এ `blueprints/course_management/models.py` file এ `ActiveSemesterConfig` model নেই।

## সমাধান: Manually Add Model

### Step 1: Check File End

```bash
cd /home/gronthon/kulawams.xyz

# File এর শেষ অংশ দেখুন
tail -30 blueprints/course_management/models.py
```

### Step 2: Add ActiveSemesterConfig Model

File edit করুন এবং `SessionArchive` class এর পরে (around line 318-319) এই code add করুন:
...
### Step 3: Using cPanel File Manager

1. cPanel → File Manager
2. Navigate: `/home/gronthon/kulawams.xyz/blueprints/course_management/`
3. `models.py` file open করুন (Edit option)
4. File এর শেষে যান (`SessionArchive` class এর পরে)
5. উপরে দেওয়া `ActiveSemesterConfig` class code add করুন
6. Save করুন

### Step 4: Or Download from GitHub
